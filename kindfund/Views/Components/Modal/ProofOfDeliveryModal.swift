...
struct ProofOfDeliveryModal: View {
    var body: some View {
        ZStack {
            Rectangle()
            ...
            VStack {
                PrimaryTitle(text: "Proof of Delivery")
                
                Spacer().frame(height: 20)
                
                PrimarySubTitle(text: "Please submit images of your delivery (bag at the front office) for KIND Fund records",
